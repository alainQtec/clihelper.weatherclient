...
#!/usr/bin/env pwsh
# .SYNOPSIS
#   clihelper.weatherclient buildScript v0.1.0
# .DESCRIPTION
#   A custom build script for the module clihelper.weatherclient
# .LINK
#   https://github.com/alainQtec/clihelper.weatherclient/blob/main/build.ps1
# .EXAMPLE
#   ./build.ps1 -Task Test
